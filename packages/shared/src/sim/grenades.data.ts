import { FLASH_FUSE, HE_FUSE, MAX_FLASH_CARRY, MOLOTOV_FUSE, SMOKE_FUSE } from '../constants.js';
...
export const GRENADES: Record<GrenadeKind, GrenadeDef> = {
  ...
  flash: { id: 'flash', name: 'Flashbang', price: 200, fuse: FLASH_FUSE, maxCarry: MAX_FLASH_CARRY, killReward: 300 },
