...
export const GRENADES: Record<GrenadeKind, GrenadeDef> = {
  he: { id: 'he', name: 'HE Grenade', price: 300, fuse: HE_FUSE, maxCarry: 1 },
  flash: { id: 'flash', name: 'Flashbang', price: 200, fuse: 1.6, maxCarry: MAX_FLASH_CARRY },
  smoke: { id: 'smoke', name: 'Smoke Grenade', price: 300, fuse: SMOKE_FUSE, maxCarry: 1 },
  molotov: { id: 'molotov', name: 'Molotov', price: 400, team: 'T', fuse: MOLOTOV_FUSE, maxCarry: 1, fire: true },
  incendiary: { id: 'incendiary', name: 'Incendiary Grenade', price: 500, team: 'CT', fuse: MOLOTOV_FUSE, maxCarry: 1, fire: true },
};
